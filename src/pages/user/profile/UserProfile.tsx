  ...
  return (
      ...
      <div className="overflow-hidden rounded-sm border border-surface-600 bg-surface-200 shadow-md ">
        <div className="relative z-20 h-36 md:h-64">
          ...
          />
          <div className="absolute bottom-1 right-1 z-10 xs:bottom-4 xs:right-4">
            <label
              htmlFor="cover"
              className="flex cursor-pointer items-center justify-center gap-2 rounded bg-primary-400 py-1 px-2 text-sm font-medium text-white hover:bg-opacity-90 xs:px-4"
            >
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          ...
          <div className="mt-4">
            ...
            <p className="font-medium text-white ">Ui/Ux Designer</p>
            <div className="mx-auto mt-5 mb-6 grid max-w-96 grid-cols-3 rounded-md border border-surface-300 py-2.5 shadow-sm bg-[#37404F]">
              <div className="flex flex-col items-center justify-center gap-1 border-r border-surface-300 px-4 xs:flex-row">
              ...
              <div className="flex flex-col items-center justify-center gap-1 px-4 xs:flex-row">
                <span className="font-semibold text-white">
                  2K
                </span>
