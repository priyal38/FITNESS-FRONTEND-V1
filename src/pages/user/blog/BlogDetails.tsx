...
const BlogDetails = (props: Props) => { 
  ...
  return (
    ...
    <div className="mb-4 md:mb-0 w-full mx-auto lg:w-[90%] ">
        ...
        <img src={`http://localhost:5000/${blogDetails?.coverImg}`} className="w-full object-cover lg:rounded sm:h-[24rem] h-72"/>
      </div>

      < div className="flex flex-col justify-center lg:flex-row lg:space-x-12">

        <div className="px-4 lg:px-0 mt-12 text-gray-200  tracking-wide text-md leading-relaxed w-full lg:w-[90%]  ">
