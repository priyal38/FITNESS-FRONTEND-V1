...
const Features = (props: Props) => {
  return (
    <>
      ...
      <div className='flex  flex-col  md:flex-row   p-2 justify-around gap-3 md:mb-10' >
        {/* =================card1================== */}

        <div className="p-6  bg-gray-800 border border-gray-200 rounded-lg shadow-md shadow-gray-600">  
